...
function fadeOutFE(notification, timeExpired) // 2 ham fadeout giong y chang nhau, chi la tach ra thoi
{
...
function fadeInFE(notification, fadeDuration = 1) 
{
...
function fadeOutBE(notification, timeExpired) // 2 ham fadeout giong y chang nhau, chi la tach ra thoi
{
   // clear any existing fade-out timer
